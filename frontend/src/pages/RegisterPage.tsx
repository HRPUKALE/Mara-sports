          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3 p-4 border rounded-md">
              ...
              <div className="flex-1">
                <Label htmlFor="studentIdUpload" className="text-sm cursor-pointer font-medium">
                ...
                {files.studentIdImage && (
                  <p className="text-xs text-green-600 mt-1">✓ {files.studentIdImage.name}</p>
                )}
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 p-4 border rounded-md">
              <Upload className="h-4 w-4 text-muted-foreground" />
              <div className="flex-1">
                <Label htmlFor="ageProofUpload" className="text-sm cursor-pointer font-medium">
                  Upload Age Proof Image *
                </Label>
                <Input
                  id="ageProofUpload"
                  type="file"
                  accept="image/*"
                  onChange={(e) => handleFileChange("ageProofImage", e.target.files?.[0] || null)}
                  className="mt-1"
                />
                {files.ageProofImage && (
                  <p className="text-xs text-green-600 mt-1">✓ {files.ageProofImage.name}</p>
                )}
              </div>
            </div>
          </div>
